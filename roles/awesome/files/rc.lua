...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "b", function()
		awful.util.spawn("firefox -P")
	end, { description = "run web browser", group = "applications" }),

	-- flameshot
	awful.key({}, "Print", function()
		awful.util.spawn("flameshot gui")
	end, { description = "run flameshot", group = "applications" }),
...
awful.spawn.with_shell("xrandr --output eDP-1 --off --output HDMI-1 --mode 2560x1080 --pos 0x0 --rotate normal")
